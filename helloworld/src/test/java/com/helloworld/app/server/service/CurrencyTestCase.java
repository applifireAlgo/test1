...
public class CurrencyTestCase {
    ...
    public void test1Save() {
        try {
            ...
            country.setCapital("SmVQVtHU1u6oCzqP7Bx8hePLfVID9hHY");
            country.setCapitalLatitude(10);
            country.setCapitalLongitude(9);
            country.setCountryCode1("JN4");
            country.setCountryCode2("hPN");
            country.setCountryFlag("vccVOEJ52Phwv43e0MOXmf6oSvE1Hb8PcZ5PrO86RNMyJcmRLI");
            country.setCountryName("s2MmUcLS0ILDAUOaLFUp7a7OAL1v5RAWGpAD6Eoq3YFZhqRV6s");
            country.setCurrencyCode("343");
            country.setCurrencyName("25Q98egOwtw3M6d0QA1EGvZHv0GDE3UvDfaid3mJS700r8geKq");
            country.setCurrencySymbol("2ENkAomxP1rVeZJVYp1WUXjqUFkTEIzZ");
            country.setIsoNumeric(9);
            Country CountryTest = countryRepository.save(country);
            map.put("CountryPrimaryKey", country._getPrimarykey());
            Currency currency = new Currency();
            currency.setCountryId((java.lang.String) CountryTest._getPrimarykey());
            currency.setCurrencyCode("wo5nwttSWUF59hsoyPJZHIw4uPm7QoIj3PXC9sr7VGiCqu2qmU");
            currency.setUnicodeDecimal("pPFjn8aXIqThdiHnmFiJ13cyg5Rok7kM8UrdeKCWhTG12Qu7wf");
            currency.setUnicodeHex("usHejKw5lLrled0AdbU8B5iRAcC5WjRg0jHA2rQ2737To2Tb4A");
    ...
    public void test2Update() {
        try {
            ...
            currency.setCurrencyCode("97WMpuI6b0FhSGjaf2wa7bUiuTUfa1OA3xTukhdjoXDxQxPsew");
            currency.setUnicodeDecimal("fOUtmmnXIL8wciMUXMtHd3tIIDx7xvtosErsyC8aUrGmNowzQd");
            currency.setUnicodeHex("vNkhkOySbkr7MH5GPB4KJOaG6ZEs9kHa7URTmqi4zVosbBxX8l");
