 ...
 * 
 */
Ext.define('Helloworld.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Helloworld.view.logalarm.LogAlarmMainViewController',
			'Helloworld.view.logalarm.tree.LogAlarmTreePanel',
			'Helloworld.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
