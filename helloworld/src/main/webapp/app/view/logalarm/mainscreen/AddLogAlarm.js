 ...
 * 
 */
Ext.define('Helloworld.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Helloworld.view.logalarm.mainscreen.AddLogAlarmController',
			'Helloworld.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Helloworld.view.logalarm.mainscreen.AppAlarmPanel',
