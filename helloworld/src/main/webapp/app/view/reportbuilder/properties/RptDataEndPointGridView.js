Ext.define('Helloworld.view.reportbuilder.properties.RptDataEndPointGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Helloworld.view.reportbuilder.properties.RptDataEndPointGridController'],
