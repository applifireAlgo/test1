Ext.define('Helloworld.view.reportbuilder.querycriteria.QueryCriteriaView', {
	extend : 'Ext.grid.Panel',
	requires:['Helloworld.view.reportbuilder.querycriteria.QueryCriteriaController',
	          'Helloworld.store.QueryCriteriaWidgetsStore',
	          'Ext.grid.RowEditor',
	          'Helloworld.view.reportbuilder.querycriteria.QueryCriteriaModel'
	          ],
	...
	columns : [
				...
				},
				{
					...
					editor : {
						...
						store : 'Helloworld.store.QueryCriteriaWidgetsStore',
						queryMode : 'local',
						forceSelection : true,
						triggerAction : 'all',
						selectOnFocus : true,
