Ext.define('Helloworld.view.reportbuilder.reportBuilder.ReportConfigurationView', {
	extend : 'Ext.panel.Panel',
	requires: ['Helloworld.view.reportbuilder.querycriteria.QueryCriteriaView',
	           'Helloworld.view.reportbuilder.gridconfig.GridConfigView',
	           'Helloworld.view.reportbuilder.properties.PropertiesPanelView',
	           'Helloworld.view.reportbuilder.sql.SqlListPanelView'],
    xtype:'report-config',
   	layout:'border', 
   	items:[
   	       {
