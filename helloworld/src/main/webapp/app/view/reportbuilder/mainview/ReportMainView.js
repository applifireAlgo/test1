Ext.define('Helloworld.view.reportbuilder.mainview.ReportMainView', {
	extend : 'Ext.panel.Panel',
    requires:[
             'Helloworld.view.reportbuilder.reportlist.ReportListPanelView',
             'Helloworld.view.reportbuilder.reportBuilder.ReportBuilderView',
             'Helloworld.view.reportbuilder.mainview.ReportMainController'
             ],
