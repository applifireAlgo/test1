...
Ext
		.define(
				'Helloworld.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Helloworld.view.logger.tabs.details.DetailsTab',
							'Helloworld.view.logger.tabs.fileconnector.FileConnectorTab',
							'Helloworld.view.logger.tabs.dbconnector.DBConnectorTab',
							'Helloworld.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Helloworld.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Helloworld.view.logger.LogConfigurationTabPanelController',
