 ...
 * 
 */
Ext.define('Helloworld.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Helloworld.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
