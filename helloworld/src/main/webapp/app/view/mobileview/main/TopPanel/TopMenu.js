Ext.define('Helloworld.view.mobileview.main.TopPanel.TopMenu', { 
	extend: 'Ext.toolbar.Toolbar',
    xtype: 'topMenu',
    requires:['Helloworld.view.mobileview.main.TopPanel.TopMenuController',/*'Helloworld.view.mobileview.main.ResourceWindow'*/],
        ...
        items: [
                {		text: 'Resorces',
                		handler:function(panel,e,eOpts)
                    	{
                    		debugger;
                    		var westAccodianPanel = this.up().up().up().up().up().down('#appMenuTreePanel');
                    		var resourceWindow = Ext.create('Helloworld.view.mobileview.main.ResourceWindow');
