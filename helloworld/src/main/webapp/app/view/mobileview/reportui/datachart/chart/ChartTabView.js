Ext.define('Helloworld.view.mobileview.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Helloworld.view.mobileview.reportui.datachart.chart.RatingField','Helloworld.view.mobileview.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
