Ext.define('Helloworld.view.mobileview.resource.ResourcePanelController', {
		...
		debugger;
				...
				for (var j = 0; j < this.formResourcePanel.items.length; j++) {
					...
					if(me.formResourcePanel.items.items[j].title == record.menuLabel)
						{
							var treePanel = new Ext.create('Helloworld.view.mobileview.resource.AppMenuTreePanel');
