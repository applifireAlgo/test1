Ext.define('Helloworld.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Helloworld.view.usermanagement.admin.UserPasswordReset',
	            'Helloworld.view.usermanagement.admin.AddUserDetails',
	            'Helloworld.view.usermanagement.admin.ViewUser'],
