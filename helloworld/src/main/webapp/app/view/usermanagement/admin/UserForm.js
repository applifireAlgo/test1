Ext.define('Helloworld.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Helloworld.view.usermanagement.admin.AddUserDetailsViewModel', 'Helloworld.model.AddUserDataModel' ],
