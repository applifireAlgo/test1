Ext.define('Helloworld.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Helloworld.view.usermanagement.enduser.UserProfileController', 'Helloworld.view.usermanagement.admin.AddUserDetailsViewModel', 'Helloworld.model.AddUserDataModel' ],
