Ext.define('Helloworld.view.mainleftmenutree.MainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'mainPanelWithLeftMenu',

	requires : [ 'Helloworld.view.resource.ResourcePanel',
			'Helloworld.view.mainleftmenutree.TopPanel.TopPanel',
			'Ext.layout.container.Accordion', 'Ext.Img', 'Ext.button.Split',
			'Helloworld.view.resource.DockedResourcePanel','Helloworld.view.fw.mainViewPanel.MainPanelController' ],
