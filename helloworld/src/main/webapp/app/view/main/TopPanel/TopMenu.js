Ext.define('Helloworld.view.main.TopPanel.TopMenu', { 
	extend: 'Ext.toolbar.Toolbar',
    xtype: 'topMenu',
    requires:['Helloworld.view.main.TopPanel.TopMenuController',/*'Helloworld.view.main.ResourceWindow'*/],
        ...
        items: [
                {		text: 'Resorces',
                		handler:function(panel,e,eOpts)
                    	{
                    		debugger;
                    		var westAccodianPanel = this.up().up().up().up().up().down('#appMenuTreePanel');
                    		var resourceWindow = Ext.create('Helloworld.view.main.ResourceWindow');
