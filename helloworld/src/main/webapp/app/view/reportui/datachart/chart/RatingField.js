...
Ext.define('Helloworld.view.reportui.datachart.chart.RatingField', {
	...
	onRender: function(ct, position) {
		Helloworld.view.reportui.datachart.chart.RatingField.superclass.onRender.call(this, ct, position);
	 ...
	 */
	initEvents: function() {
		Helloworld.view.reportui.datachart.chart.RatingField.superclass.initEvents.call(this);
