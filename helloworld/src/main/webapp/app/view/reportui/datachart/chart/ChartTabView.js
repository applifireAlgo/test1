Ext.define('Helloworld.view.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Helloworld.view.reportui.datachart.chart.RatingField','Helloworld.view.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
