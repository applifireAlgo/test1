 ...
 * 
 */
Ext.define('Helloworld.view.searchengine.searchsetup.SearchSetupMainPanel', 
{
	extend : 'Ext.panel.Panel',
	xtype : 'searchsetup',
	requires : [ 'Ext.layout.container.HBox', 'Ext.layout.container.VBox', 'Helloworld.view.searchengine.searchsetup.SearchSetupMainPanelController',
	             'Helloworld.view.searchengine.searchsetup.ChartFieldsModel',
	           ],
