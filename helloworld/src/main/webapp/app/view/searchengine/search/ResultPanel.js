Ext
		.define(
				'Helloworld.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Helloworld.view.searchengine.search.SearchEngineMainPanelController','Helloworld.view.searchengine.search.PanelHeaderField' ,'Helloworld.view.searchengine.search.ReportGridView','Helloworld.view.searchengine.search.ReportChartView','Helloworld.view.searchengine.search.documentView','Helloworld.view.searchengine.search.DouMeanView','Helloworld.view.googlemaps.map.MapPanel'],
