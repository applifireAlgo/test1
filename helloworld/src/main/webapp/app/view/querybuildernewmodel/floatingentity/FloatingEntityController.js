Ext.define('Helloworld.view.querybuildernewmodel.floatingentity.FloatingEntityController',
{
			extend : 'Ext.app.ViewController',
			alias : 'controller.floating-entity',
			requires:['Helloworld.view.querybuildernewmodel.floatingentity.EntityColumnGrid',
			          'Helloworld.view.querybuildernewmodel.queryentitiesjoins.Query',
			          'Helloworld.view.querybuildernewmodel.floatingentity.EntitySprite',
