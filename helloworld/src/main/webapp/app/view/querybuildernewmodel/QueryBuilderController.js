Ext.define('Helloworld.view.querybuildernewmodel.QueryBuilderController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-builder',
	requires:['Helloworld.view.querybuildernewmodel.queryentitiesjoins.QueryFieldsStore',
	          'Helloworld.view.querybuildernewmodel.queryentitiesjoins.QueryEntitiesStore',
	          'Helloworld.view.querybuildernewmodel.queryentitiesjoins.EntityJoinStore',
	...
	openQueryDetailWindow : function(saveBtn){
		...
		var queryWindow = Ext.create('Helloworld.view.querybuildernewmodel.querydetail.QueryDetail');
