Ext.define('Helloworld.view.querybuildernewmodel.querycondition.QueryWhereCondition', {
	extend : 'Ext.tree.TreePanel',
	requires:['Helloworld.view.querybuildernewmodel.querycondition.QueryWhereConditionController'],
