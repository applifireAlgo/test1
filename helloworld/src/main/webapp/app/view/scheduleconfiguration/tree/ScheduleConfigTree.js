 ...
 * 
 */
Ext.define("Helloworld.view.scheduleconfiguration.tree.ScheduleConfigTree", {
	extend : 'Ext.panel.Panel',
	requires : [ 'Helloworld.view.scheduleconfiguration.tree.ScheduleConfigTreeController' ],
