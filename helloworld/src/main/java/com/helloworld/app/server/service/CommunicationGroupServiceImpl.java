...
@SourceCodeAuthorClass(createdBy = "viral.patel@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Service for CommunicationGroup Master table Entity", complexity = Complexity.LOW)
...
public class CommunicationGroupServiceImpl extends CommunicationGroupService {
    ...
    public HttpEntity<ResponseBean> findAll() throws SpartanPersistenceException, Exception {
        ...
        java.util.List<com.helloworld.app.shared.contacts.CommunicationGroup> lstcommunicationgroup = communicationGrouprepo.findAll();
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            com.helloworld.app.shared.contacts.CommunicationGroup lstcommunicationgroup = communicationGrouprepo.findById((String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstcommunicationgroup);
        } catch (org.springframework.transaction.TransactionException e) {
