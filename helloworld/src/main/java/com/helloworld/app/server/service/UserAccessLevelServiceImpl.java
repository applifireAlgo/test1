...
@SourceCodeAuthorClass(createdBy = "viral.patel@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Service for UserAccessLevel Master table Entity", complexity = Complexity.LOW)
...
public class UserAccessLevelServiceImpl extends UserAccessLevelService {
    ...
    public HttpEntity<ResponseBean> findAll() throws SpartanPersistenceException, Exception {
        ...
        java.util.List<com.helloworld.app.shared.authentication.UserAccessLevel> lstuseraccesslevel = userAccessLevelrepo.findAll();
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            com.helloworld.app.shared.authentication.UserAccessLevel lstuseraccesslevel = userAccessLevelrepo.findById((String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstuseraccesslevel);
        } catch (org.springframework.transaction.TransactionException e) {
