package com.helloworld.app.shared.contacts;
...
import com.helloworld.app.shared.EntityAudit;
import javax.persistence.Embedded;
import com.helloworld.app.shared.SystemInfo;
...
public class CoreContacts implements Serializable, CommonEntityInterface, CoreContactsInterface, Comparator<CoreContacts> {
    ...
    public CoreContacts addAddress(Address _address) {
        if (this.address == null) {
            this.address = new java.util.ArrayList<com.helloworld.app.shared.location.Address>();
        }
        if (_address != null) {
    ...
    public CoreContacts addCommunicationData(CommunicationData _communicationData) {
        if (this.communicationData == null) {
            this.communicationData = new java.util.ArrayList<com.helloworld.app.shared.contacts.CommunicationData>();
        }
    ...
    public boolean equals(Object obj) {
        try {
            com.helloworld.app.shared.contacts.CoreContacts other = (com.helloworld.app.shared.contacts.CoreContacts) obj;
            if (contactId == null) {
                return false;
