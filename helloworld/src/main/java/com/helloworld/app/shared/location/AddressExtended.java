package com.helloworld.app.shared.location;
...
public class AddressExtended implements Serializable, CommonEntityInterface, Comparator<AddressExtended> {
    ...
    public boolean equals(Object obj) {
        try {
            com.helloworld.app.shared.location.AddressExtended other = (com.helloworld.app.shared.location.AddressExtended) obj;
            if (addExtId == null) {
                return false;
